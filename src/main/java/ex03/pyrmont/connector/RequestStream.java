...
/**
 * Convenience implementation of <b>ServletInputStream</b> that works with the standard implementations of <b>Request</b>
 * if the content length has been set on our associated Request ,this implementation will enforce not reading more than that mant bytes on
...
public class RequestStream extends ServletInputStream {
    ...
    /**
     * The content length past which we will not read ,or -1 if there
     ...
     * <code>len</code> bytes,but a smaller number actually read is
     * read is returned as an integer .This method blocks until input data is available

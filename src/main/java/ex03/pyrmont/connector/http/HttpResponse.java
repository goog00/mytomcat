...
public class HttpResponse implements HttpServletResponse{
     ...
     * This collection is keyed by the header name.and the elements are ArrayList containing the associated values that have been set
     */
     ...
     */
    protected final SimpleDateFormat format = new SimpleDateFormat("EE, dd MMM yyyy HH:mm:ss zzz",Locale.US);
    ...
    protected void sendHeaders() throws IOException{
        ...
        outputWriter.print("\r\n");
        //send the content-length and content-type header (if any)
